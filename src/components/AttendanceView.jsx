                    ...
                    <td style={{ padding: '0.85rem 1rem' }}>
                      <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                        <div style={{ 
                          ...
                          {emp.photo 
                            ? <img src={`http://localhost:5000/uploads/${emp.photo}`} alt="" style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
                    ...
                    <td style={{ padding: '0.85rem 1rem' }}>
                      <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
                        <div style={{ width: '32px', height: '32px', borderRadius: '50%', backgroundColor: '#eff6ff', display: 'flex', alignItems: 'center', justifyContent: 'center', fontWeight: 600, color: '#3b82f6', overflow: 'hidden', fontSize: '0.85rem' }}>
                          {log.employee_photo 
                            ? <img src={`http://localhost:5000/uploads/${log.employee_photo}`} alt="" style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
                      ...
                      <div style={{ display: 'flex', gap: '6px' }}>
                        {log.clock_in_photo && (
                          <div style={{ width: '32px', height: '32px', borderRadius: '6px', overflow: 'hidden', border: '2px solid #22c55e' }}>
                            <img src={`http://localhost:5000/uploads/${log.clock_in_photo}`} alt="In" style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
                          </div>
                        )}
                        {log.clock_out_photo && (
                          <div style={{ width: '32px', height: '32px', borderRadius: '6px', overflow: 'hidden', border: '2px solid #ef4444' }}>
                            <img src={`http://localhost:5000/uploads/${log.clock_out_photo}`} alt="Out" style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
                          </div>
                        )}
