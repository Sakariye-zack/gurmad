...
export const api = {
  ...
  sendDigestNow: (phone) => fetch(`${API_BASE_URL}/admin/send-digest-now`, {
    method: 'POST', headers: { 'Content-Type': 'application/json', ...getAuthHeaders() }, body: JSON.stringify({ phone })
  }).then(handleResponse),
